  ...
  try {
    ...
    const message = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p><a href="${resetUrl}" style="display:inline-block;padding:10px 16px;background:#8a0fb3;color:#fff;border-radius:6px;text-decoration:none;">Reset Password</a></p>
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production") {
        return res.json({
          message:
            "Password reset email could not be sent, use resetUrl for testing",
          resetUrl,
        });
      }
