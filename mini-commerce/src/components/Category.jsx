...
const Category = () => {
  ...
  return (
    <div
      data-aos="zoom-in"
      className="w-full py-[50px] px-[20px] md:px-[7%] bg-gradient-to-br from-gray-50 to-purple-50"
    >
      {/* Header Section */}
      <div className="text-center mb-12">
        <h1
          className="text-3xl md:text-[48px] font-bold mb-4"
          style={{ color: "#8a0fb3" }}
        >
        ...
        {categories.map((category, index) => (
          ...
          >
            <div className="relative overflow-hidden rounded-2xl h-[320px] md:h-[380px] shadow-xl">
              ...
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/30 transition-opacity duration-300 group-hover:bg-black/60" />
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {hairTypes.map((type, idx) => (
            <Link key={idx} to={`/shop?type=${type.slug}`} className="group">
      ...
      {/* CTA Banner */}
      <div className="mt-16 bg-gradient-to-r from-[#8a0fb3] to-[#b98800] rounded-2xl p-8 text-center">
        ...
        <button
          onClick={() =>
            (window.location.href = "https://wa.me/message/DSAULOSKOI4XG1")
          }
          className="bg-white px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg"
          style={{ color: "#8c6020" }}
        >
          Chat with Expert →
        </button>
