...
const Footer = () => {
  ...
  return (
    <div className='w-full pt-[5%]  flex flex-col gap-4 justify-center items-center bg-[#F0F0F0]'>
      {/* for footer logo */}
        <div className='w-full py-[20px]  px-[7%] flex flex-col md:hidden gap-4'>
      ...
      <div className='w-full py-[3%] px-[7%] grid grid-row-3 grid-cols-[1fr_1fr] md:grid-rows-1 md:grid-cols-[1fr_1fr_1fr_1fr_1fr] gap-5 justify-between border-b-2 border-[#0000001A]'>
        {/* for footer logo */}
        ...
        <div className='w-full flex flex-col gap-4'>
          <h2 className='text-[16px] font-medium'>COMPANY</h2>
          <div className='flex flex-col gap-2 text-[#00000099]'>
            <Link to='/about' className='text-[16px] font-medium'>About</Link>
            <Link to='/feature' className='text-[16px] font-medium'>Feature</Link>
            <Link to='/privacy' className='text-[16px] font-medium'>Works</Link>
            <Link to='/privacy' className='text-[16px] font-medium'>Career</Link>
          </div>
        </div>
        {/* for help links */}
        <div className='w-full flex flex-col gap-4'>
        ...
        {/* for resources */}
        <div className='w-full flex flex-col gap-4'>
          <h2 className='text-[16px] font-medium'>RESOURCES</h2>
          <div className='flex flex-col gap-2 text-[#00000099]'>
            <Link to='/about' className='text-[16px] font-medium'>Free eBooks</Link>
            <Link to='/feature' className='text-[16px] font-medium'>Development Tutorial</Link>
            <Link to='/privacy' className='text-[16px] font-medium'>How to - Blog</Link>
            <Link to='/privacy' className='text-[16px] font-medium'>YouTube Playlist</Link>
          </div>
        </div>
      </div>
      ...
      <div className='w-full pb-[15px] px-[7%] flex flex-col md:flex-row justify-center md:justify-between items-center'>
        <p className='w-full'>Shop.co © {year}, All Rights Reserved</p>
