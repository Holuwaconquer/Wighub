    ...
    <div className="w-full pt-[18%] md:pt-[5%]  flex flex-col gap-4 justify-center items-center bg-gradient-to-br from-purple-100 to-pink-100">
      <div className="w-full py-[3%] px-[7%] flex flex-col md:flex-row items-start justify-between border-b-2 border-[#0000001A]">
        ...
        <div className="w-full flex flex-col gap-4 mb-4">
          ...
          <p className="text-[14px] w-full md:w-3/4 text-[#00000099]">
            Premium, Donor 100% Virgin Hair Extensions Luxury bundles, wigs &
            custom units DM for inquiries, worldwide shipping.
          </p>
          ...
          <div className="relative">
            ...
            <div className="relative flex items-end gap-x-3">
              ...
              <div className="relative">
                <a
                  href="https://www.facebook.com/share/1EEMZYwyYF/?mibextid=wwXIfr"
                  target="_blank"
        ...
        <div className="w-full flex flex-col gap-1 mb-4">
          ...
          <div className="flex flex-col gap-2 text-[#00000099]">
            <Link
              to="https://wa.me/message/DSAULOSKOI4XG1"
