...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <div className='flex items-center justify-between gap-2 sm:gap-4'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <button 
                ...
                className='lg:hidden p-2 hover:bg-white/20 rounded-lg transition-all duration-300 hover:scale-110 active:scale-95'
            ...
            {/* Search Bar - Desktop */}
            <form onSubmit={handleSearch} className='hidden lg:flex flex-1 max-w-md mx-4 transition-all duration-300'>
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`fixed inset-0 bg-black/50 z-50 transition-all duration-500 ease-in-out lg:hidden ${
