...
const Newsletter = () => {
  return (
    <div className='w-full px-[7%] flex flex-col gap-4 justify-center items-center '>
        <div className='w-full bg-[#8c6020] text-white rounded-[20px] py-[36px] px-[20px] md:px-[64px] translate-y-[70px] flex flex-col md:flex-row justify-center items-center gap-4 md:gap-15'>
