...
const Newsletter = () => {
  return (
    <div className='w-full bg-gray-50 px-[7%] flex flex-col gap-4 justify-center items-center '>
        <div className='w-full bg-[#b98800] text-white rounded-[20px] py-[36px] px-[20px] md:px-[64px] translate-y-[70px] flex flex-col md:flex-row justify-center items-center gap-4 md:gap-15'>
